...
DELETE FROM items WHERE categoria = 'carrera';
...
(
  ...
  ARRAY['economía', 'administración', 'contabilidad', 'derecho', 'negocios', 'gestión'],
  '[]'::jsonb,
  '{}'::jsonb
),
(
  ...
  ARRAY['humanidades', 'ciencias sociales', 'educación', 'comunicación', 'cultura', 'sociedad'],
  '[]'::jsonb,
  '{}'::jsonb
),
(
  ...
  ARRAY['tecnología', 'informática', 'ingeniería', 'biotecnología', 'ciencias aplicadas', 'innovación'],
  '[]'::jsonb,
  '{}'::jsonb
);
